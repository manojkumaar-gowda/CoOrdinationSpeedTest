<?php
    ...
    $emaill = $_COOKIE["user"];
    $sql = "SELECT q1 FROM test2 where email='$emaill'";
    ...
    // Create connection
    $emaill = $_COOKIE["user"];
    $sql = "SELECT email FROM test2 where email='$emaill'";
    $result = $conn->query($sql);
    $email = "";
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO test2 VALUES ('$emaill','$start','','','','','','','','','','','','','','','','','')";
    ...
    if(isset($_POST['next1'])){
        ...
        if($x1!="" && $x2!="" && $x3!="" && $x4!="" && $x5!="" && $x6!="" && $x7!="" && $x8!="" && $x9!="" && $x10!="" && $x11!="" && $x12!="" && $x13!="" && $x14!="" && $x15!=""){
            ...
            $emaill = $_COOKIE["user"];
            $sql = "UPDATE test2 SET q1='$x1',q2='$x2',q3='$x3',q4='$x4',q5='$x5',q5='$x5',q6='$x6',q7='$x7',q8='$x8',q9='$x9',q10='$x10',q11='$x11',q12='$x12',q13='$x13',q14='$x14',q15='$x15',q16='$x16',endtime='$end'  WHERE email='$emaill'";
            if ($conn->query($sql) === TRUE) {      
                header('Location:realtest3.php');
                exit;
            } else {
...
<body>
    ...
    <form action="starttest2.php" method="post">
        <div id="myCarousel" class="carousel slide" >
            ...
            <div class="carousel-inner" style="padding-top:30%;padding-bottom:25%;">
                <div class="item active" style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">HEALTHY</h1>
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">POLITE</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">GREED</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">LOYAL</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">POVERTY</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">ILLITERACY</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">TERRORISM</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                   <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">LOVE</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">CALM</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                   <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">CUNNING</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">ABUSE</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">EMPATHY</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">Bad</p>
                    <p style="margin-left:75%;margin-top:-9%;">Good</p>  
                    <h1 class="text-primary" style="text-align:center;margin-top:50%;margin-bottom:30%;">RELIGIOUS</h1>
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
