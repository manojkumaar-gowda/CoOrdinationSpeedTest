<?php
    ...
    $emaill = $_COOKIE["user"];
    $sql = "SELECT q1 FROM test5 where email='$emaill'";
    ...
    // Create connection
    $emaill = $_COOKIE["user"];
    $sql = "SELECT email FROM test5 where email='$emaill'";
    $result = $conn->query($sql);
    $email = "";
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO test5 VALUES ('$emaill','$start','','','','','','','','','','','','','','','','','')";
    ...
    if(isset($_POST['next1'])){
        ...
        if($x1!="" && $x2!="" && $x3!="" && $x4!="" && $x5!="" && $x6!="" && $x7!="" && $x8!="" && $x9!="" && $x10!="" && $x11!="" && $x12!="" && $x13!="" && $x14!="" && $x15!=""){
            ...
            $emaill = $_COOKIE["user"];
            $sql = "UPDATE test5 SET q1='$x1',q2='$x2',q3='$x3',q4='$x4',q5='$x5',q5='$x5',q6='$x6',q7='$x7',q8='$x8',q9='$x9',q10='$x10',q11='$x11',q12='$x12',q13='$x13',q14='$x14',q15='$x15',q16='$x16',endtime='$end'  WHERE email='$emaill'";
            if ($conn->query($sql) === TRUE) {      
                header('Location:testcompleted.php');
                exit;
            } else {
...
<body>
    ...
    <form action="starttest5.php" method="post">
        <div id="myCarousel" class="carousel slide" >
            ...
            <div class="carousel-inner" style="padding-top:30%;padding-bottom:25%;">
                <div class="item active" style="padding:20px;"> 
                    <p style="margin-left:11%;">Good/North Indian</p>
                    <p style="margin-left:55%;margin-top:-10%;">Bad/South Indian</p>  
