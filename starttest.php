<?php
    ...
    $emaill = $_COOKIE["user"];
    $sql = "SELECT q1 FROM test1 where email='$emaill'";
    ...
    // Create connection
    $emaill = $_COOKIE["user"];
    $sql = "SELECT email FROM test1 where email='$emaill'";
    $result = $conn->query($sql);
    $email = "";
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO test1 VALUES ('$emaill','$start','','','','','','','','','','','','','','','','','')";
    ...
    if(isset($_POST['next1'])){
        ...
        if($x1!="" && $x2!="" && $x3!="" && $x4!="" && $x5!="" && $x6!="" && $x7!="" && $x8!="" && $x9!="" && $x10!="" && $x11!="" && $x12!="" && $x13!="" && $x14!="" && $x15!=""){
            ...
            $emaill = $_COOKIE["user"];
            $sql = "UPDATE test1 SET q1='$x1',q2='$x2',q3='$x3',q4='$x4',q5='$x5',q5='$x5',q6='$x6',q7='$x7',q8='$x8',q9='$x9',q10='$x10',q11='$x11',q12='$x12',q13='$x13',q14='$x14',q15='$x15',q16='$x16',endtime='$end'  WHERE email='$emaill'";
            if ($conn->query($sql) === TRUE) {      
                header('Location:realtest2.php');
                exit;
            } else {
        ...
        <div id="myCarousel" class="carousel slide" >
            ...
            <div class="carousel-inner" style="padding-top:30%;padding-bottom:25%;">
                <div class="item active" style="padding:20px;"> 
                    <p style="margin-left:11%;">North-Indian</p>
                    <p style="margin-left:65%;margin-top:-9%;">South-Indian</p>  
                ...
                <div class="item " style="padding:20px;"> 
                    <p style="margin-left:11%;">North-Indian</p>
                    <p style="margin-left:65%;margin-top:-9%;">South-Indian</p>  
                    <img src="images/n4.jpg" alt="" style="margin-left:15%;" width="70%">
                    <div style="margin-left:40%;margin-bottom:25%;margin-top:15%;">
                        <div class="form-check">
